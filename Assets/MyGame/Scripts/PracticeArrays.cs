...
public class PracticeArrays : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Name des ersten GameObjects: " + myRedImages[0].name);
        ...
        Debug.Log("Name des letzten GameObjects: " + myRedImages[myRedImages.Length -1].name);
